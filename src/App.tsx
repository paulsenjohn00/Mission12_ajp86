    ...
    return (
      <div className='card m-3'>
        <div className='card-body'>
          <h5 className='card-title'>School Name: {singleTeam.school}</h5>
          <p className='card-text'>Mascot: {singleTeam.name} <br /> Location: {singleTeam.city}, {singleTeam.state}</p>
        </div>
      </div>
    );
    }
...
function TeamList() {
return (
<div>{teamNames.map(singleTeam => <Team {...singleTeam}/>)}</div>
);
}
